...
VALUES
    ...
    (2, 'Testing 02', 'This product is just a testing due to the current situation is testing.', 19.99, 2, '3DP002V', 'static/images/dummy2.png', 'active'),
    (3, 'Testing 03', 'This product is just a testing due to the current situation is testing.', 29.99, 3, '3DP003O', 'static/images/dummy3.png', 'active'),
    (4, 'Testing 04', 'This product is just a testing due to the current situation is testing.', 39.99, 4, 'ELE001K', 'static/images/dummy4.png', 'active'),
    (5, 'Testing 05', 'This product is just a testing due to the current situation is testing.', 49.99, 5, 'ELE002B', 'static/images/dummy5.png', 'active'),
    (6, 'Testing 06', 'This product is just a testing due to the current situation is testing.', 59.99, 6, 'ELE003C', 'static/images/dummy6.png', 'active'),
    (7, 'Testing 07', 'This product is just a testing due to the current situation is testing.', 69.99, 7, 'ELE004W', 'static/images/dummy7.png', 'active'),
